...
from airflow.operators.capstone_plugin import (RawToPostgresOperator, LoadFactOperator,
...
dq_check_complete_operator = DummyOperator(task_id='DQ_check_complete',  dag=dag)
...
run_player_dq_check >> dq_check_complete_operator
run_tourney_dq_check >> dq_check_complete_operator
run_ranking_dq_check >> dq_check_complete_operator
run_matches_dq_check >> dq_check_complete_operator
dq_check_complete_operator >> load_player_history_table
dq_check_complete_operator >> load_tourney_champions_table
